...
farmer_df = pd.read_csv(r"D:\Farming_ai_hackathon\Data\farmer_advisor_dataset.csv")
...
market_df = pd.read_csv(r"D:\Farming_ai_hackathon\Data\market_researcher_dataset.csv")
